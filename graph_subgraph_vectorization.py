...
def get_all_connected_subgraphs(G, max_size):
    ...
    #con_comp should be useless as our graphs are all connected
...
def get_hash_dict_subgraphs(subgraphs) :
    ...
    return [nx.weisfeiler_lehman_graph_hash(subgraph, edge_attr="labels", node_attr="labels", iterations=3, digest_size=16) for subgraph in subgraphs]
